...
class _AccountCreationPageState extends State<AccountCreationPage> {
  ...
  final pagePadding = const EdgeInsets.symmetric(horizontal: 20, vertical: 16);
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final pagePadding = const EdgeInsets.symmetric(horizontal: 20, vertical: 32);
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              if (success.isNotEmpty) {
                                ...
                                setState(() => _errorMessage = 'Login failed. Please check your email or password.');
                              }
                            } catch (e) {
                          ...
                          try {
                            final success = await Provider.of<AccountHandler>(context, listen: false)
                                .updateAccountDetails(
                                    _dateOfBirth, _role, _privacy, _golf, _gender, _country, Globals.sessionToken);
                            if (success.isNotEmpty) {
                              Globals.isGuest = false;
                              if (!mounted) return;
                              Navigator.pushNamedAndRemoveUntil(
                              ...
                              setState(() => _errorMessage = 'Failed to save your profile. Please try again.');
                            }
                          } catch (e) {
